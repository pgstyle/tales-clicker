...
public final class AppUtils {
    ...
    private static final Path ASSET_STORE;
    ...
    static {
        ...
        ASSET_STORE = Paths.get("/META-INF/org.pgstyle/autoutils/tales-clicker/");
    ...
    public static InputStream getResource(String name) {
        return Optional.ofNullable(name)
                .map(AppUtils.ASSET_STORE::resolve).map(Path::normalize)
     ...
     * method is equivalent to {@code AppUtils.getResources("./")}
     *
    ...
    public static Stream<String> listDirectory(String path) {
        List<String> files = new ArrayList<>();
        String target = AppUtils.ASSET_STORE.resolve(path).normalize().toString().replace("\\", "/");
